...
const statusOptions: StatusOption[] = [
  { value: "ONLINE" as OnlineState, labelKey: "friends.status.online", color: "#22c55e", glow: "0 0 8px rgba(34, 197, 94, 0.6)" },
  { value: "AFK" as OnlineState, labelKey: "friends.status.away", color: "#f97316", glow: "0 0 8px rgba(249, 115, 22, 0.6)" },
  { value: "BUSY" as OnlineState, labelKey: "friends.status.busy", color: "#ef4444", glow: "0 0 8px rgba(239, 68, 68, 0.6)" },
  { value: "INVISIBLE" as OnlineState, labelKey: "friends.status.invisible", color: "#6b7280", glow: "none" },
];
