...
const getBorderRadiusStyle = (borderRadius?: number): React.CSSProperties => {
...
export const getTextSizeClass = (size: ComponentSize, element: "button" | "input" | "badge" | "label" | "checkbox" = "label"): string => {
if (element === "badge") {
    switch (size) {
