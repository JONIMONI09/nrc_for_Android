...
import net.kdt.pojavlaunch.firefly.customcontrols.gamepad.Gamepad;
import net.kdt.pojavlaunch.firefly.customcontrols.gamepad.GamepadMapperAdapter;
...
public class GamepadMapperFragment extends Fragment implements
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> mGrabStateAdapter = new ArrayAdapter<>(view.getContext(), android.R.layout.simple_spinner_dropdown_item);
